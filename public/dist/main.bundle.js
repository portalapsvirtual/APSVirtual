...
var GlobalEventsManager = /** @class */ (function () {
    function GlobalEventsManager() {
        this._registeredUser = new BehaviorSubject_1.BehaviorSubject(false);
...
var ng_bootstrap_2 = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/index.js");
...
var common_service_1 = __webpack_require__("./src/app/common.service.ts");
...
var NgbDateCustomParserFormatter_1 = __webpack_require__("./src/app/components/tools/NgbDateCustomParserFormatter.ts");
//RUTAS 
...
var search_pipe_1 = __webpack_require__("./src/app/components/tools/search-pipe.ts");
//COMPONENTES
var app_component_1 = __webpack_require__("./src/app/app.component.ts");
var not_found_component_1 = __webpack_require__("./src/app/components/not-found.component.ts");
var user_list_component_1 = __webpack_require__("./src/app/components/user/user-list/user-list.component.ts");
var user_edit_component_1 = __webpack_require__("./src/app/components/user/user-edit/user-edit.component.ts");
var user_details_component_1 = __webpack_require__("./src/app/components/user/user-details/user-details.component.ts");
...
var user_login_component_1 = __webpack_require__("./src/app/components/user/user-login/user-login.component.ts");
var user_register_component_1 = __webpack_require__("./src/app/components/user/user-register/user-register.component.ts");
var menu_bar_component_1 = __webpack_require__("./src/app/components/menu-bar/menu-bar.component.ts");
var footer_component_1 = __webpack_require__("./src/app/components/footer/footer.component.ts");
var GlobalEventsManager_1 = __webpack_require__("./src/app/GlobalEventsManager.ts");
...
var field_error_display_component_1 = __webpack_require__("./src/app/components/tools/field-error-display/field-error-display.component.ts");
...
var navigation_menu_experiencias_component_1 = __webpack_require__("./src/app/components/experiencias/navigation-menu-experiencias/navigation-menu-experiencias.component.ts");
...
var experiencias_search_component_1 = __webpack_require__("./src/app/components/experiencias/experiencias-search/experiencias-search.component.ts");
var enlaces_externos_component_1 = __webpack_require__("./src/app/components/enlaces-externos/enlaces-externos.component.ts");
var contacto_component_1 = __webpack_require__("./src/app/components/contacto/contacto.component.ts");
var experiencias_create_component_1 = __webpack_require__("./src/app/components/experiencias/experiencias-create/experiencias-create.component.ts");
...
var experiencias_update_component_1 = __webpack_require__("./src/app/components/experiencias/experiencias-update/experiencias-update.component.ts");
var experiencias_detail_component_1 = __webpack_require__("./src/app/components/experiencias/experiencias-detail/experiencias-detail.component.ts");
var universidades_component_1 = __webpack_require__("./src/app/components/universidades/universidades.component.ts");
var ambitos_component_1 = __webpack_require__("./src/app/components/ambitos/ambitos.component.ts");
var especialidades_component_1 = __webpack_require__("./src/app/components/especialidades/especialidades.component.ts");
...
var universidades_list_component_1 = __webpack_require__("./src/app/components/universidades/universidades-list/universidades-list.component.ts");
var especialidades_list_component_1 = __webpack_require__("./src/app/components/especialidades/especialidades-list/especialidades-list.component.ts");
var ambitos_list_component_1 = __webpack_require__("./src/app/components/ambitos/ambitos-list/ambitos-list.component.ts");
var universidades_add_component_1 = __webpack_require__("./src/app/components/universidades/universidades-add/universidades-add.component.ts");
var especialidades_add_component_1 = __webpack_require__("./src/app/components/especialidades/especialidades-add/especialidades-add.component.ts");
var especialidades_edit_component_1 = __webpack_require__("./src/app/components/especialidades/especialidades-edit/especialidades-edit.component.ts");
var universidades_edit_component_1 = __webpack_require__("./src/app/components/universidades/universidades-edit/universidades-edit.component.ts");
var biblio_recursos_externos_list_component_1 = __webpack_require__("./src/app/components/biblio-recursos-externos/biblio-recursos-externos-list/biblio-recursos-externos-list.component.ts");
var biblio_recursos_externos_edit_component_1 = __webpack_require__("./src/app/components/biblio-recursos-externos/biblio-recursos-externos-edit/biblio-recursos-externos-edit.component.ts");
var biblio_recursos_externos_add_component_1 = __webpack_require__("./src/app/components/biblio-recursos-externos/biblio-recursos-externos-add/biblio-recursos-externos-add.component.ts");
var proyectos_list_component_1 = __webpack_require__("./src/app/components/proyectos/proyectos-list/proyectos-list.component.ts");
var proyectos_create_component_1 = __webpack_require__("./src/app/components/proyectos/proyectos-create/proyectos-create.component.ts");
var proyectos_search_component_1 = __webpack_require__("./src/app/components/proyectos/proyectos-search/proyectos-search.component.ts");
var proyectos_update_component_1 = __webpack_require__("./src/app/components/proyectos/proyectos-update/proyectos-update.component.ts");
...
var proyectos_iniciar_reclutamiento_component_1 = __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-iniciar-reclutamiento/proyectos-iniciar-reclutamiento.component.ts");
var proyectos_alistar_component_1 = __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-alistar/proyectos-alistar.component.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                user_view_profile_component_1.UserViewProfileComponent,
                navigation_menu_experiencias_component_1.NavigationMenuExperienciasComponent,
                experiencias_list_component_1.ExperienciasListComponent,
                experiencias_component_1.ExperienciasComponent,
                experiencias_search_component_1.ExperienciasSearchComponent,
                enlaces_externos_component_1.EnlacesExternosComponent,
                contacto_component_1.ContactoComponent,
                experiencias_create_component_1.ExperienciasCreateComponent,
                terms_component_1.TermsComponent,
                politics_component_1.PoliticsComponent,
                experiencias_update_component_1.ExperienciasUpdateComponent,
                experiencias_detail_component_1.ExperienciasDetailComponent,
                universidades_component_1.UniversidadesComponent,
                ambitos_component_1.AmbitosComponent,
                especialidades_component_1.EspecialidadesComponent,
                biblio_recursos_externos_component_1.BiblioRecursosExternosComponent,
                universidades_list_component_1.UniversidadesListComponent,
                especialidades_list_component_1.EspecialidadesListComponent,
                ambitos_list_component_1.AmbitosListComponent,
                universidades_add_component_1.UniversidadesAddComponent,
                especialidades_add_component_1.EspecialidadesAddComponent,
                especialidades_edit_component_1.EspecialidadesEditComponent,
                universidades_edit_component_1.UniversidadesEditComponent,
                biblio_recursos_externos_list_component_1.BiblioRecursosExternosListComponent,
                biblio_recursos_externos_edit_component_1.BiblioRecursosExternosEditComponent,
                biblio_recursos_externos_add_component_1.BiblioRecursosExternosAddComponent,
                pairs_pipe_1.PairsPipe,
                array_sort_pipe_1.OrderBy,
                search_pipe_1.SearchPipe,
                proyectos_list_component_1.ProyectosListComponent,
                proyectos_create_component_1.ProyectosCreateComponent,
                proyectos_search_component_1.ProyectosSearchComponent,
                ...
                proyectos_iniciar_reclutamiento_component_1.ProyectosIniciarReclutamientoComponent,
                proyectos_alistar_component_1.ProyectosAlistarComponent,
...
var appRoutes = [
    ...
    },
    {
        ...
        component: user_view_profile_component_1.UserViewProfileComponent,
        canActivate: [auth_1.AuthGuard]
    },
    {
        path: 'userUpdate',
    ...
    {
        path: 'experiencias',
        component: experiencias_component_1.ExperienciasComponent
    },
    // {
    ...
    {
        path: 'experiencias-list',
        component: experiencias_list_component_1.ExperienciasListComponent
    },
    {
    ...
    },
    {
        ...
        component: experiencias_detail_component_1.ExperienciasDetailComponent
    },
    {
        path: 'experiencias-search',
        component: experiencias_search_component_1.ExperienciasSearchComponent
    },
    {
        path: 'proyectos',
    ...
    },
    {
        ...
        component: proyectos_detail_component_1.ProyectosDetailComponent
    },
    {
        path: 'proyectos-search',
        component: proyectos_search_component_1.ProyectosSearchComponent
    },
    {
        path: 'enlaces-externos',
        component: enlaces_externos_component_1.EnlacesExternosComponent
    },
    {
        path: 'universidades',
    ...
    },
    {
        ...
        component: biblio_recursos_externos_component_1.BiblioRecursosExternosComponent
    },
    {
        path: 'contacto',
    ...
    {
        path: 'politica',
        component: politics_component_1.PoliticsComponent
    },
    {
        path: 'terminos',
...
exports.AmbitosListComponent = AmbitosListComponent;
...
exports.AmbitosComponent = AmbitosComponent;
...
exports.BiblioRecursosExternosAddComponent = BiblioRecursosExternosAddComponent;
...
exports.BiblioRecursosExternosEditComponent = BiblioRecursosExternosEditComponent;
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var user_1 = __webpack_require__("./src/app/components/user/user.ts");
var exp_service_1 = __webpack_require__("./src/app/components/experiencias/exp.service.ts");
var auth_service_1 = __webpack_require__("./src/app/auth.service.ts");
...
exports.BiblioRecursosExternosListComponent = BiblioRecursosExternosListComponent;
...
exports.BiblioRecursosExternosComponent = BiblioRecursosExternosComponent;
...
exports.EnlacesExternosComponent = EnlacesExternosComponent;
...
exports.EspecialidadesAddComponent = EspecialidadesAddComponent;
...
exports.EspecialidadesEditComponent = EspecialidadesEditComponent;
...
exports.EspecialidadesListComponent = EspecialidadesListComponent;
...
exports.EspecialidadesComponent = EspecialidadesComponent;
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var http_1 = __webpack_require__("./node_modules/@angular/http/esm5/http.js"); //Para manejar los verbos http
var Subject_1 = __webpack_require__("./node_modules/rxjs/_esm5/Subject.js");
__webpack_require__("./node_modules/rxjs/_esm5/add/operator/map.js");
var ExpService = /** @class */ (function () {
    ...
    ExpService.prototype.getExperiencias = function (ambitoId) {
        var _this = this;
        var headers = new http_1.Headers({ 'x-access-token': ambitoId });
        headers.append('Content-Type', 'application/json');
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    ExpService.prototype.getImages = function (expId) {
        var _this = this;
        var headers = new http_1.Headers({ 'x-access-token': expId });
        headers.append('Content-Type', 'application/json');
        var options = new http_1.RequestOptions({ headers: headers });
...
module.exports = ".nv-file-over { border: dotted 3px red; } /* Default class applied to drop zones on over */ .another-file-over-class { border: dotted 3px green; } .my-drop-zone { border: dotted 3px lightgray; }"
    ...
    ExperienciasCreateComponent.prototype.save = function (model) {
        ...
        this._expService.createExperiencia(this.newExp).subscribe(function (res) {
            if (res['success'] == true) {
                ...
                console.log("Grabado correctamente");
                _this._router.navigate(['/experiencias']);
            }
            else {
...
exports.ExperienciasCreateComponent = ExperienciasCreateComponent;
...
exports.ExperienciasDetailComponent = ExperienciasDetailComponent;
...
exports.ExperienciasListComponent = ExperienciasListComponent;
...
exports.ExperienciasSearchComponent = ExperienciasSearchComponent;
...
var ExperienciasUpdateComponent = /** @class */ (function () {
    ...
    function ExperienciasUpdateComponent(authService, _expService, router, _location, _fb) {
        ...
        this.model = {
            ...
            month: moment(this.updateExp.fecha.toString(), "DD/MM/YYYY").month() + 1,
        ...
        this.myForm = _fb.group({
            ...
            'descripcion': ['', forms_1.Validators.required],
            'fecha': ['', forms_1.Validators.required],
            'ambito': [this.updateExpAmbito, forms_1.Validators.required],
            'especialidad': ['', forms_1.Validators.required],
            'universidad': ['', forms_1.Validators.required],
        });
...
exports.ExperienciasUpdateComponent = ExperienciasUpdateComponent;
...
exports.ExperienciasComponent = ExperienciasComponent;
...
exports.NavigationMenuExperienciasComponent = NavigationMenuExperienciasComponent;
...
exports.PoliticsComponent = PoliticsComponent;
...
exports.NavigationMenuProyectosComponent = NavigationMenuProyectosComponent;
...
module.exports = ".nv-file-over { border: dotted 3px red; } /* Default class applied to drop zones on over */ .another-file-over-class { border: dotted 3px green; } .my-drop-zone { border: dotted 3px lightgray; } #div_entidad {\r\n    background-color: rgb(248, 245, 212)\r\n\r\n}"
...
var ProyectosCreateComponent = /** @class */ (function () {
    function ProyectosCreateComponent(_projService, _expService, _router, _location, _fb) {
        ...
        this.myForm = _fb.group({
            'nombre': ['', forms_1.Validators.required],
            'nombre_entidad': ['', forms_1.Validators.required],
            'email_entidad': ['', forms_1.Validators.required],
            'provincia': ['', forms_1.Validators.required],
            'municipio_entidad': ['', forms_1.Validators.required],
            'descripcion': ['', forms_1.Validators.required],
            'ambito': [null, forms_1.Validators.required],
            'adjuntos': this._fb.array([
                this.initAdjuntos(),
...
exports.ProyectosCreateComponent = ProyectosCreateComponent;


/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-alistar/proyectos-alistar.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-alistar/proyectos-alistar.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" [style.backgroundColor]=\"'#999999'\">\n  <hr>\n  <h2 [style.color]=\"'#333333'\"> Inscripción en proyecto de ApS</h2>\n  <div class=\"alert {{typeAlert}}\"> {{messageHead}}\n  </div>\n  <hr>\n  <!-- ALUMNO-->\n  <!--NOMBRE-->\n\n  <div>\n    <p> <span class=\"negrita\">Nombre del alumno: </span>{{user.first_name}} {{user.last_name}} ({{user.email}})</p>\n    <p><span class=\"negrita\">Número máximo de alumnos para este proyecto: </span> {{updateProj.cupo_estudiantes}}</p>\n    <p><span class=\"negrita\">Actualmente inscritos: </span>{{inscritos}}</p>\n    <p><span class=\"negrita\">Plazas vacantes: </span>{{updateProj.plazas}}</p>\n  </div>\n  <!-- BOTONES -->\n  <div class=\"row\">\n    <div class=\"col-md-3\"  *ngIf=\"accion != 2\">\n      <button type=\"submit\" class=\"button submit\" (click)=update();>\n        <i class=\"fa fa-check\"></i> {{accionMsg}}\n      </button>\n    </div>\n    <div class=\"col-md-3\">\n      <button type=\"button\" class=\"button cancel\" (click)=cancel();>\n        <i class=\"fa fa-times\"></i> Cancelar\n      </button>\n    </div>\n    <div class=\"alert alert-danger\" *ngIf=\"message\">{{message}}</div>\n  </div>\n  <hr>\n</div>\n\n<!-- ************************************************************************** -->\n<!-- MODAL apadrinar -->\n<!-- ************************************************************************** -->\n\n<bs-modal [animation]=\"animation\" [keyboard]=\"keyboard\" [backdrop]=\"backdrop\" (onClose)=\"modalAlistarClosed()\" (onDismiss)=\"modalAlistarDismissed()\"\n  (onOpen)=\"modalAlistarOpened()\" #modalAlistar>\n  <bs-modal-header>\n    <h4 class=\"modal-title\">APS Virtual</h4>\n  </bs-modal-header>\n  <bs-modal-body>\n    <p>{{modalMsg}}</p>\n  </bs-modal-body>\n  <bs-modal-footer>\n    <button type=\"button\" class=\"button expanded submit\" (click)=\"modalAlistar.close()\">\n      <i class=\"fa fa-check\"></i> ok\n    </button>\n    <button type=\"button\" data-dismiss=\"modal\" class=\"button expanded cancel\" (click)=\"modalAlistar.dismiss()\">\n      <i class=\"fa fa-times\"></i> Cancelar\n    </button>\n  </bs-modal-footer>\n</bs-modal>"

/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-alistar/proyectos-alistar.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var proyectos_service_1 = __webpack_require__("./src/app/components/proyectos/proyectos.service.ts");
var auth_service_1 = __webpack_require__("./src/app/auth.service.ts");
var ProyectosAlistarComponent = /** @class */ (function () {
    function ProyectosAlistarComponent(_projService, authService) {
        var _this = this;
        this._projService = _projService;
        this.authService = authService;
        this.alistar = new core_1.EventEmitter();
        ...
        this.updateProj.alumnos.forEach(function (element) {
            if (_this.user.email == element.email) {
                _this.accionMsg = "Cancelar subscripción";
                _this.accion = 1; //Cancelar subscripcion
                _this.typeAlert = "alert-warning";
                _this.modalMsg = "Está a punto cancelar su subscripción para este proyecto. ¿Desea continuar?";
                _this.messageHead = " Usted ya se encuentra subscrito como alumno al presente proyecto de ApS. Mediante el siguiente formulario podrá,  si así lo desea,  cancelar su subscripción.";
            }
        });
        var alumno = {
    ...
    ProyectosAlistarComponent.prototype.ngOnInit = function () {
    };
    ProyectosAlistarComponent.prototype.ngOnDestroy = function () {
        if (this.subscriptionToAlistar != null)
            this.subscriptionToAlistar.unsubscribe();
    };
    ProyectosAlistarComponent.prototype.cancel = function () {
        this.alistar.emit(false); //Emitter
    };
    ProyectosAlistarComponent.prototype.update = function (form) {
        console.log("Formulario ", form);
        this.modalAlistar.open();
    };
    ProyectosAlistarComponent.prototype.modalAlistarDismissed = function () {
        console.log("Modal cerrado sin acción");
    };
    ProyectosAlistarComponent.prototype.modalAlistarOpened = function () {
        /**No hacer nada*/
    };
    ProyectosAlistarComponent.prototype.modalAlistarClosed = function () {
        var _this = this;
        ...
        this.subscriptionToAlistar = this._projService.updateProyecto(this.updateProj, 3).subscribe(function (res) {
            if (res['success'] == true) {
                _this.updateProj.estado = { id: 3, nombre: "Fase de reclutamiento" };
                _this._projService.setProj(_this.updateProj);
                _this.alistar.emit(_this.updateProj); //Emitter
                if (_this.accion == 0)
                    alert("Alistado en el proyecto con éxito");
                else if (_this.accion = 1)
                    alert("Subscripcion cancelada con éxito");
            }
            else {
                _this.alistar.emit(false); //Emitter
                alert("Algo ha ido mal");
            }
        });
    };
    __decorate([
        core_1.ViewChild('modalAlistar'),
        __metadata("design:type", ng2_bs3_modal_1.BsModalComponent)
    ], ProyectosAlistarComponent.prototype, "modalAlistar", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], ProyectosAlistarComponent.prototype, "proyecto", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ProyectosAlistarComponent.prototype, "alistar", void 0);
    ProyectosAlistarComponent = __decorate([
        core_1.Component({
            selector: 'app-proyectos-alistar',
            template: __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-alistar/proyectos-alistar.component.html"),
            styles: [__webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-alistar/proyectos-alistar.component.css")]
        }),
        __metadata("design:paramtypes", [proyectos_service_1.ProyectosService,
            auth_service_1.AuthService])
    ], ProyectosAlistarComponent);
    return ProyectosAlistarComponent;
}());
exports.ProyectosAlistarComponent = ProyectosAlistarComponent;
...
var ProyectosApadrinarComponent = /** @class */ (function () {
    ...
    ProyectosApadrinarComponent.prototype.modalApadrinarClosed = function () {
        ...
        this.subscriptionToApadrinarProj = this._projService.updateProyecto(this.updateProj, 1).subscribe(function (res) {
            if (res['success'] == true) {
                _this.updateProj.estado = { id: 2, nombre: "apadrinado" };
...
/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-arrancar/proyectos-arrancar.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-arrancar/proyectos-arrancar.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" [style.backgroundColor]=\"'#999999'\">\n    <hr>\n    <h2 [style.color]=\"'#333333'\"> Inicio del desarrollo del proyecto de ApS</h2>\n    <div class=\"alert alert-info\"> Mediante la siguiente acción se dispone a finalizar la fase de reclutamiento de alumnos para el proyecto y dar por iniciado su desarrollo. Si acepta esta acción no se podran subscribir mas alumnos. \n    </div>\n    <hr>\n    <!-- ALUMNO-->\n    <!--NOMBRE-->\n  \n    <div>\n      <p><span class=\"negrita\">Número máximo de alumnos para este proyecto: </span> {{updateProj.cupo_estudiantes}}</p>\n      <p><span class=\"negrita\">Actualmente inscritos: </span>{{inscritos}}</p>\n      <div *ngFor =\"let alumno of updateProj.alumnos; let i = index\">\n        <p> <span class=\"negrita\">Alumno {{i}}: </span>    {{alumno.nombre}} - {{alumno.email}} </p>\n      </div>\n      <p><span class=\"negrita\">Plazas vacantes: </span>{{updateProj.plazas}}</p>\n    </div>\n    <!-- BOTONES -->\n    <div class=\"row\">\n      <div class=\"col-md-3\"  *ngIf=\"accion != 2\">\n        <button type=\"submit\" class=\"button submit\" (click)=update();>\n          <i class=\"fa fa-check\"></i> Iniciar proyecto\n        </button>\n      </div>\n      <div class=\"col-md-3\">\n        <button type=\"button\" class=\"button cancel\" (click)=cancel();>\n          <i class=\"fa fa-times\"></i> Cancelar\n        </button>\n      </div>\n      <div class=\"alert alert-danger\" *ngIf=\"message\">{{message}}</div>\n    </div>\n    <hr>\n  </div>\n  \n  <!-- ************************************************************************** -->\n  <!-- MODAL apadrinar -->\n  <!-- ************************************************************************** -->\n  \n  <bs-modal [animation]=\"animation\" [keyboard]=\"keyboard\" [backdrop]=\"backdrop\" (onClose)=\"modalArrancarClosed()\" (onDismiss)=\"modalArrancarDismissed()\"\n    (onOpen)=\"modalArrancarOpened()\" #modalArrancar>\n    <bs-modal-header>\n      <h4 class=\"modal-title\">APS Virtual</h4>\n    </bs-modal-header>\n    <bs-modal-body>\n      <p>\n        Se dispone a finalizar la fase de reclutamiento de alumnos y dar por iniciado el desarrollo del proyecto. ¿Está seguro de que desea continuar?\n      </p>\n    </bs-modal-body>\n    <bs-modal-footer>\n      <button type=\"button\" class=\"button expanded submit\" (click)=\"modalArrancar.close()\">\n        <i class=\"fa fa-check\"></i> ok\n      </button>\n      <button type=\"button\" data-dismiss=\"modal\" class=\"button expanded cancel\" (click)=\"modalArrancar.dismiss()\">\n        <i class=\"fa fa-times\"></i> Cancelar\n      </button>\n    </bs-modal-footer>\n  </bs-modal>"

/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-arrancar/proyectos-arrancar.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var proyectos_service_1 = __webpack_require__("./src/app/components/proyectos/proyectos.service.ts");
var auth_service_1 = __webpack_require__("./src/app/auth.service.ts");
var ProyectosArrancarComponent = /** @class */ (function () {
    function ProyectosArrancarComponent(_projService, authService) {
        this._projService = _projService;
        this.authService = authService;
        this.arrancar = new core_1.EventEmitter();
        this.updateProj = JSON.parse(JSON.stringify(this._projService.proyecto));
        this.inscritos = this.updateProj.cupo_estudiantes - this.updateProj.plazas;
    }
    ProyectosArrancarComponent.prototype.ngOnInit = function () {
    };
    ProyectosArrancarComponent.prototype.ngOnDestroy = function () {
        if (this.subscriptionToArrancar != null)
            this.subscriptionToArrancar.unsubscribe();
    };
    ProyectosArrancarComponent.prototype.cancel = function () {
        this.arrancar.emit(false); //Emitter
    };
    ProyectosArrancarComponent.prototype.update = function (form) {
        this.modalArrancar.open();
    };
    ProyectosArrancarComponent.prototype.modalArrancarDismissed = function () {
        console.log("Modal cerrado sin acción");
    };
    ProyectosArrancarComponent.prototype.modalArrancarOpened = function () {
        /**No hacer nada*/
    };
    ProyectosArrancarComponent.prototype.modalArrancarClosed = function () {
        var _this = this;
        this.subscriptionToArrancar = this._projService.updateProyecto(this.updateProj, 4).subscribe(function (res) {
            if (res['success'] == true) {
                _this.updateProj.estado = { id: 4, nombre: "Fase de desarrollo" };
                _this._projService.setProj(_this.updateProj);
                _this.arrancar.emit(_this.updateProj); //Emitter
                alert("Proyecto arrancado con éxito");
            }
            else {
                _this.arrancar.emit(false); //Emitter
                alert("Algo ha ido mal");
            }
        });
    };
    __decorate([
        ...
        __metadata("design:type", ng2_bs3_modal_1.BsModalComponent)
    ], ProyectosArrancarComponent.prototype, "modalArrancar", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], ProyectosArrancarComponent.prototype, "proyecto", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ProyectosArrancarComponent.prototype, "arrancar", void 0);
    ProyectosArrancarComponent = __decorate([
        core_1.Component({
            selector: 'app-proyectos-arrancar',
            template: __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-arrancar/proyectos-arrancar.component.html"),
            styles: [__webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-arrancar/proyectos-arrancar.component.css")]
        }),
        __metadata("design:paramtypes", [proyectos_service_1.ProyectosService,
            auth_service_1.AuthService])
    ], ProyectosArrancarComponent);
    return ProyectosArrancarComponent;
}());
exports.ProyectosArrancarComponent = ProyectosArrancarComponent;


/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-cancelar/proyectos-cancelar.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-cancelar/proyectos-cancelar.component.html":
/***/ (function(module, exports) {

module.exports = "<p>\n  proyectos-cancelar works!\n</p>\n"

/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-cancelar/proyectos-cancelar.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var ProyectosCancelarComponent = /** @class */ (function () {
    function ProyectosCancelarComponent() {
    }
    ProyectosCancelarComponent.prototype.ngOnInit = function () {
    };
    ProyectosCancelarComponent = __decorate([
        core_1.Component({
            selector: 'app-proyectos-cancelar',
            template: __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-cancelar/proyectos-cancelar.component.html"),
            styles: [__webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-cancelar/proyectos-cancelar.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], ProyectosCancelarComponent);
    return ProyectosCancelarComponent;
}());
exports.ProyectosCancelarComponent = ProyectosCancelarComponent;
...
var ProyectosDetailComponent = /** @class */ (function () {
    ...
    ProyectosDetailComponent.prototype.alistarReceiver = function (event) {
        (this.updAction != 3) ? this.updAction = 3 : this.updAction = 0;
        if (event == false)
            return;
        this.proyecto = event;
    ...
    ProyectosDetailComponent.prototype.arrancar = function (prokId) {
        console.log("Arrancar ...");
        (this.updAction != 4) ? this.updAction = 4 : this.updAction = 0;
    };
    ProyectosDetailComponent.prototype.arrancarReceiver = function (event) {
        (this.updAction != 4) ? this.updAction = 4 : this.updAction = 0;
        if (event == false)
            return;
        this.proyecto = event;
...
exports.ProyectosDetailComponent = ProyectosDetailComponent;


/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-finalizar/proyectos-finalizar.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-finalizar/proyectos-finalizar.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" [style.backgroundColor]=\"'#999999'\">\n    <hr>\n    <h2 [style.color]=\"'#333333'\"> Finalización del  desarrollo del proyecto de ApS</h2>\n    <div class=\"alert alert-info\"> Mediante la siguiente acción se dispone a concluir la fase de desarrollo del proyecto y darlo por finalizado. \n    </div>\n    <hr>\n  \n    <!-- BOTONES -->\n    <div class=\"row\">\n      <div class=\"col-md-3\"  *ngIf=\"accion != 2\">\n        <button type=\"submit\" class=\"button submit\" (click)=update();>\n          <i class=\"fa fa-check\"></i> Finalizar proyecto\n        </button>\n      </div>\n      <div class=\"col-md-3\">\n        <button type=\"button\" class=\"button cancel\" (click)=cancel();>\n          <i class=\"fa fa-times\"></i> Cancelar\n        </button>\n      </div>\n      <div class=\"alert alert-danger\" *ngIf=\"message\">{{message}}</div>\n    </div>\n    <hr>\n  </div>\n  \n  <!-- ************************************************************************** -->\n  <!-- MODAL apadrinar -->\n  <!-- ************************************************************************** -->\n  \n  <bs-modal [animation]=\"animation\" [keyboard]=\"keyboard\" [backdrop]=\"backdrop\" (onClose)=\"modalArrancarClosed()\" (onDismiss)=\"modalArrancarDismissed()\"\n    (onOpen)=\"modalArrancarOpened()\" #modalArrancar>\n    <bs-modal-header>\n      <h4 class=\"modal-title\">APS Virtual</h4>\n    </bs-modal-header>\n    <bs-modal-body>\n      <p>\n        Va a dar por concluida la fase de desarrollo del proyecto y a marcarlo como finalizado. ¿Está seguro de que desea continuar?\n      </p>\n    </bs-modal-body>\n    <bs-modal-footer>\n      <button type=\"button\" class=\"button expanded submit\" (click)=\"modalArrancar.close()\">\n        <i class=\"fa fa-check\"></i> ok\n      </button>\n      <button type=\"button\" data-dismiss=\"modal\" class=\"button expanded cancel\" (click)=\"modalArrancar.dismiss()\">\n        <i class=\"fa fa-times\"></i> Cancelar\n      </button>\n    </bs-modal-footer>\n  </bs-modal>"

/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-finalizar/proyectos-finalizar.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var proyectos_service_1 = __webpack_require__("./src/app/components/proyectos/proyectos.service.ts");
var auth_service_1 = __webpack_require__("./src/app/auth.service.ts");
var ProyectosFinalizarComponent = /** @class */ (function () {
    function ProyectosFinalizarComponent(_projService, authService) {
        this._projService = _projService;
        this.authService = authService;
        this.finalizar = new core_1.EventEmitter();
        this.updateProj = JSON.parse(JSON.stringify(this._projService.proyecto));
        this.inscritos = this.updateProj.cupo_estudiantes - this.updateProj.plazas;
    }
    ProyectosFinalizarComponent.prototype.ngOnDestroy = function () {
        if (this.subscriptionToArrancar != null)
            this.subscriptionToArrancar.unsubscribe();
    };
    ProyectosFinalizarComponent.prototype.ngOnInit = function () {
    };
    ProyectosFinalizarComponent.prototype.cancel = function () {
        this.finalizar.emit(false); //Emitter
    };
    ProyectosFinalizarComponent.prototype.update = function (form) {
        this.modalArrancar.open();
    };
    ProyectosFinalizarComponent.prototype.modalArrancarDismissed = function () {
        console.log("Modal cerrado sin acción");
    };
    ProyectosFinalizarComponent.prototype.modalArrancarOpened = function () {
        /**No hacer nada*/
    };
    ProyectosFinalizarComponent.prototype.modalArrancarClosed = function () {
        var _this = this;
        this.subscriptionToArrancar = this._projService.updateProyecto(this.updateProj, 5).subscribe(function (res) {
            if (res['success'] == true) {
                _this.updateProj.estado = { id: 5, nombre: "Proyecto finalizado" };
                _this._projService.setProj(_this.updateProj);
                _this.finalizar.emit(_this.updateProj); //Emitter
                alert("Proyecto finalizado con éxito");
            }
            else {
                _this.finalizar.emit(false); //Emitter
                alert("Algo ha ido mal");
            }
        });
    };
    __decorate([
        core_1.ViewChild('modalArrancar'),
        __metadata("design:type", ng2_bs3_modal_1.BsModalComponent)
    ], ProyectosFinalizarComponent.prototype, "modalArrancar", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], ProyectosFinalizarComponent.prototype, "proyecto", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ProyectosFinalizarComponent.prototype, "finalizar", void 0);
    ProyectosFinalizarComponent = __decorate([
        core_1.Component({
            selector: 'app-proyectos-finalizar',
            template: __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-finalizar/proyectos-finalizar.component.html"),
            styles: [__webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-finalizar/proyectos-finalizar.component.css")]
        }),
        __metadata("design:paramtypes", [proyectos_service_1.ProyectosService,
            auth_service_1.AuthService])
    ], ProyectosFinalizarComponent);
    return ProyectosFinalizarComponent;
}());
exports.ProyectosFinalizarComponent = ProyectosFinalizarComponent;


/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-iniciar-reclutamiento/proyectos-iniciar-reclutamiento.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-iniciar-reclutamiento/proyectos-iniciar-reclutamiento.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\" [style.backgroundColor]=\"'#999999'\">\n  <hr>\n  <h2 [style.color]=\"'#333333'\">Iniciar reclutamiento de alumnos para el proyecto</h2>\n  <div class=\"alert alert-info\"> Mediante el siguiente formulario, usted como docente o representante de una universidad, podrá dar por iniciada la fase de \n    reclutamiento de alumnos para el proyecto de ApS. Esto quiere decir que a partir del establecimiento de este estado, se podrán subscribir al proyecto un número de alumnos \n    no superior al estipulado en el campo de cupo de estudiantes. Este fase se concluye cuando el equipo docente estime pasar a la fase de \"Proyecto arrancado\"\n </div>\n  <hr>\n  <form [formGroup]=\"myForm\" novalidate (ngSubmit)=\"update(myForm)\">\n    <div class=\"row\">\n      <!-- CUPO_ESTUDIANTES -->\n      <div class=\"form-group col-md-2\">\n        <label class=\"required negrita\">Cupo de estudiantes</label>\n        <input type=\"number\" width=\"12\" [(ngModel)]=\"updateProj.cupo_estudiantes\" formControlName=\"cupo_estudiantes\" placeholder=\"Número máximo de estudiantes\"\n          class=\"form-control\" [ngClass]=\"{\n        'has-danger': myForm.controls.cupo_estudiantes.invalid && myForm.controls.cupo_estudiantes.dirty,\n        'has-success': myForm.controls.cupo_estudiantes.valid && myForm.controls.cupo_estudiantes.dirty\n        }\">\n      </div>\n    </div>\n    <!-- BOTONES -->\n    <div class=\"row\">\n      <div class=\"col-md-3\">\n        <button type=\"submit\" class=\"button submit\" [disabled]=\"!myForm.valid\">\n          <i class=\"fa fa-check\"></i> Aceptar cambios\n        </button>\n      </div>\n      <div class=\"col-md-3\">\n        <button type=\"button\" class=\"button cancel\" (click)=cancel();>\n          <i class=\"fa fa-times\"></i> Cancelar\n        </button>\n      </div>\n      <div class=\"alert alert-danger\" *ngIf=\"message\">{{message}}</div>\n    </div>\n    <!-- <div class=\"margin-20\">\n      <div>myForm details:-</div>\n      <pre>Is myForm valid?: <br>{{myForm.valid | json}}</pre>\n      <pre>form value: <br>{{myForm.value | json}}</pre>\n    </div> -->\n  </form>\n  <hr>\n</div>\n\n<!-- ************************************************************************** -->\n<!-- MODAL apadrinar -->\n<!-- ************************************************************************** -->\n\n<bs-modal [animation]=\"animation\" [keyboard]=\"keyboard\" [backdrop]=\"backdrop\" (onClose)=\"modalIniciarReclutamientoClosed()\" (onDismiss)=\"modalIniciarReclutamientoDismissed()\"\n  (onOpen)=\"modalIniciarReclutamientoOpened()\" #modalIniciarReclutamiento>\n  <bs-modal-header>\n    <h4 class=\"modal-title\">APS Virtual</h4>\n  </bs-modal-header>\n  <bs-modal-body>\n    <p>¿Esta a punto de inicar el reclutamiento de alumnos para este proyecto. Desea continuar?</p>\n  </bs-modal-body>\n  <bs-modal-footer>\n    <button type=\"button\" class=\"button expanded submit\" (click)=\"modalIniciarReclutamiento.close()\">\n      <i class=\"fa fa-check\"></i> ok\n    </button>\n    <button type=\"button\" data-dismiss=\"modal\" class=\"button expanded cancel\" (click)=\"modalIniciarReclutamiento.dismiss()\">\n      <i class=\"fa fa-times\"></i> Cancelar\n    </button>\n  </bs-modal-footer>\n</bs-modal>"

/***/ }),

/***/ "./src/app/components/proyectos/proyectos-detail/proyectos-iniciar-reclutamiento/proyectos-iniciar-reclutamiento.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var proyectos_service_1 = __webpack_require__("./src/app/components/proyectos/proyectos.service.ts");
var auth_service_1 = __webpack_require__("./src/app/auth.service.ts");
var ProyectosIniciarReclutamientoComponent = /** @class */ (function () {
    function ProyectosIniciarReclutamientoComponent(_projService, _fb, authService) {
        var _this = this;
        this._projService = _projService;
        this._fb = _fb;
        this.authService = authService;
        this.iniciar_reclutamiento = new core_1.EventEmitter();
        this.updateProj = JSON.parse(JSON.stringify(this._projService.proyecto));
        this.user = this.authService.user;
        this.authService.user$.subscribe(function (user) {
            _this.user = user;
        ...
        console.log("updateProj: ", this.updateProj);
        this.myForm = _fb.group({
            'cupo_estudiantes': [null, [forms_1.Validators.required, forms_1.Validators.min(1), forms_1.Validators.max(100)]],
        });
    }
    ProyectosIniciarReclutamientoComponent.prototype.ngOnInit = function () {
    };
    ProyectosIniciarReclutamientoComponent.prototype.ngOnDestroy = function () {
        if (this.subscriptionToIniciarReclutamiento != null)
            this.subscriptionToIniciarReclutamiento.unsubscribe();
    };
    ProyectosIniciarReclutamientoComponent.prototype.cancel = function () {
        this.iniciar_reclutamiento.emit(false); //Emitter
    };
    ProyectosIniciarReclutamientoComponent.prototype.update = function (form) {
        console.log("Formulario ", form);
        this.modalIniciarReclutamiento.open();
    };
    ProyectosIniciarReclutamientoComponent.prototype.modalIniciarReclutamientoDismissed = function () {
        console.log("Modal cerrado sin acción");
    };
    ProyectosIniciarReclutamientoComponent.prototype.modalIniciarReclutamientoOpened = function () {
        /**No hacer nada*/
    };
    ProyectosIniciarReclutamientoComponent.prototype.modalIniciarReclutamientoClosed = function () {
        var _this = this;
        console.log("Iniciar Reclutamiento", this.updateProj);
        console.log("Proyecto en Detail", this.proyecto);
        this.subscriptionToIniciarReclutamiento = this._projService.updateProyecto(this.updateProj, 2).subscribe(function (res) {
            if (res['success'] == true) {
                _this.updateProj.estado = { id: 3, nombre: "Fase de reclutamiento" };
                _this.iniciar_reclutamiento.emit(_this.updateProj); //Emitter
                alert("Iniciado reclutamiento en el proyecto");
            }
            else {
                _this.iniciar_reclutamiento.emit(false); //Emitter
                alert("Algo ha ido mal");
            }
        });
    };
    __decorate([
        core_1.ViewChild('modalIniciarReclutamiento'),
        __metadata("design:type", ng2_bs3_modal_1.BsModalComponent)
    ], ProyectosIniciarReclutamientoComponent.prototype, "modalIniciarReclutamiento", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], ProyectosIniciarReclutamientoComponent.prototype, "proyecto", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ProyectosIniciarReclutamientoComponent.prototype, "iniciar_reclutamiento", void 0);
    ProyectosIniciarReclutamientoComponent = __decorate([
        core_1.Component({
            selector: 'app-proyectos-iniciar-reclutamiento',
            template: __webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-iniciar-reclutamiento/proyectos-iniciar-reclutamiento.component.html"),
            styles: [__webpack_require__("./src/app/components/proyectos/proyectos-detail/proyectos-iniciar-reclutamiento/proyectos-iniciar-reclutamiento.component.css")]
        }),
        __metadata("design:paramtypes", [proyectos_service_1.ProyectosService,
            forms_1.FormBuilder,
            auth_service_1.AuthService])
            ...
            if (res['success'] == true) {
                ...
                if (_this.estadoId > 0)
                    ...
                    res['proj'].forEach(function (element) {
                        if (_this.user == null) {
                            if ((element.estado.id == 3 || element.estado.id == 4 || element.estado.id == 5) && _this.ambitoId == element.ambito_id)
                                _this.proyectos.push(element);
                        }
                        else if ((_this.user.rol_id == 1 && (_this.estadoId == 3 || _this.estadoId == 4 || _this.estadoId == 5)) || //Usuario Alumno
...
exports.ProyectosSearchComponent = ProyectosSearchComponent;
...
module.exports = "<app-navigation-menu-proyectos> </app-navigation-menu-proyectos>\n<div class=\"container\">\n  <div class=\"row\">\n    <ul class=\"breadcrumb\">\n      <li routerLinkActive=\"active\">\n        <a [routerLink]=\"['/home']\">\n          <i class=\"fa fa-home\"> Home </i>\n        </a>\n        <li routerLinkActive=\"active\">\n          <a [routerLink]=\"['/proyectos']\">\n            Proyectos APS\n          </a>\n        </li>\n        <li>Modificar proyecto existente</li>\n    </ul>\n  </div>\n  <div class=\"container-center col-md-10\">\n\n    <!-- TITULO -->\n    <h2>Modificar: {{nombreProyecto}}</h2>\n    <h4>Estado del proyecto: <span>{{updateProj.estado.nombre}}</span></h4>\n    <br>\n    <form [formGroup]=\"myForm\" novalidate (ngSubmit)=\"update(myForm)\">\n      <!--------------------------------  CAMPOS ------------------------------------------>\n      <!-- NOMBRE -->\n      <div class=\"form-group\">\n        <label class=\"required negrita\">Nombre del proyecto</label>\n        <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.nombre.valid && myForm.controls.nombre.touched\">Este campo es obligatorio</div>\n        <input type=\"text\" [(ngModel)]=\"updateProj.nombre\" formControlName=\"nombre\" placeholder=\"Introduce aquí el nombre del proyecto\"\n          class=\"form-control\">\n      </div>\n\n      <!-- DESCRIPCION -->\n      <div class=\"form-group\">\n        <label class=\"required negrita\">Descripción</label>\n        <!-- <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls['descripcion'].valid && myForm.controls['descripcion'].touched\">Este campo es obligatorio</div> -->\n        <textarea rows=\"5\" cols=\"50\" formControlName=\"descripcion\" [(ngModel)]=\"updateProj.descripcion\" placeholder=\"Descripción del proyecto\"\n          class=\"form-control\"></textarea>\n      </div>\n\n      <!-- COORDINADORES(ARRAY) -->\n      <div class=\"container form-group\" *ngIf=\"updateProj.estado.id > 1\" id=\"div_coordinadores\">\n        <h5>Coordinadores</h5>\n        <div *ngIf=\"updateProj.coordinadores != '' \" formArrayName=\"coordinadores\">\n          <div *ngFor=\"let coordinador of myForm.controls.coordinadores.controls; let i=index\">\n            <div>\n              <label class=\"negrita\">Coordinador (#{{i + 1}})</label>\n              <span class=\"fa fa-remove pull-right\" *ngIf=\"myForm.controls.coordinadores.controls.length > 0\" (click)=\"removeCoordinador(i, myForm.controls.coordinadores.controls[i].controls.email)\"></span>\n            </div>\n            <div class=\"form-group row\" [formGroupName]=\"i\">\n              <div class=\"col-md-1\"></div>\n              <!--NOMBRE-->\n              <div class=\"col-md-5\">\n                <label class=\"required\">Nombre</label>\n                <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.coordinadores.controls[i].controls.nombre.valid && myForm.controls.coordinadores.controls[i].controls.nombre.touched\">Este campo es obligatorio</div>\n                <input type=\"text\" [(ngModel)]=\"updateProj.coordinadores[i].nombre\" class=\"form-control\" formControlName=\"nombre\" placeholder=\"Nombre del coordinador\">\n              </div>\n              <!--EMAIL-->\n              <div class=\"col-md-6\">\n                <label class=\"required\">Email</label>\n                <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.coordinadores.controls[i].controls.email.valid && myForm.controls.coordinadores.controls[i].controls.email.touched\">Este campo es obligatorio</div>\n                <input type=\"email\" [(ngModel)]=\"updateProj.coordinadores[i].email\" class=\"form-control\" formControlName=\"email\" placeholder=\"Dirección de Email\">\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"row tab\">\n          <div class=\"col-md-1\"></div>\n          <button type=\"button\" class=\"button btn-form mt0\" (click)=\"addCoordinador()\">\n            <i class=\"fa fa-plus\"></i> Añadir coordinador\n          </button>\n        </div>\n        <hr>\n      </div>\n\n      <!-- ALUMNOS (ARRAY) -->\n      <div class=\"container form-group\" *ngIf=\"updateProj.estado.id > 2\"  id=\"div_alumnos\" >\n        <h5>Alumnos</h5>\n        <div *ngIf=\"updateProj.alumnos != null\" formArrayName=\"alumnos\">\n          <div *ngFor=\"let alumno of myForm.controls.alumnos.controls; let i=index\">\n            <div>\n              <label class=\"negrita\">Alumno (#{{i + 1}})</label>\n              <span class=\"fa fa-remove pull-right\" *ngIf=\"myForm.controls.alumnos.controls.length > 0\" (click)=\"removeAlumno(i, myForm.controls.alumnos.controls[i].controls.email)\"></span>\n            </div>\n            <div class=\"form-group row\" [formGroupName]=\"i\">\n              <div class=\"col-md-1\"></div>\n              <!--NOMBRE-->\n              <div class=\"col-md-5\">\n                <label class=\"required\">Nombre</label>\n                <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.alumnos.controls[i].controls.nombre.valid && myForm.controls.alumnos.controls[i].controls.nombre.touched\">Este campo es obligatorio</div>\n                <input type=\"text\" [(ngModel)]=\"updateProj.alumnos[i].nombre\" class=\"form-control\" formControlName=\"nombre\" placeholder=\"Nombre del alumno\">\n              </div>\n              <!--EMAIL-->\n              <div class=\"col-md-6\">\n                <label class=\"required\">Email</label>\n                <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.alumnos.controls[i].controls.email.valid && myForm.controls.alumnos.controls[i].controls.email.touched\">Este campo es obligatorio</div>\n                <input type=\"email\" [(ngModel)]=\"updateProj.alumnos[i].email\" class=\"form-control\" formControlName=\"email\" placeholder=\"Dirección de Email\">\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"row tab\">\n          <div class=\"col-md-1\"></div>\n          <button type=\"button\" class=\"button btn-form mt0\" (click)=\"addAlumno()\">\n            <i class=\"fa fa-plus\"></i> Añadir alumno\n          </button>\n        </div>\n        <hr>\n      </div>\n\n\n      <!-- ENTIDAD -->\n      <div class=\"container form-group\" id=\"div_entidad\">\n        <h5>Entidad demandante del proyecto</h5>\n        <div class=\"row\">\n          <!--nombre-->\n          <div class=\"col-md-5\">\n            <label class=\"required negrita\">Nombre</label>\n            <!-- <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.nombre_entidad.valid && myForm.controls.nombre_entidad.touched\">Este campo es obligatorio</div> -->\n            <input type=\"text\" [(ngModel)]=\"updateProj.entidad.nombre\" class=\"form-control\" formControlName=\"nombre_entidad\" placeholder=\"Nombre de la entidad\">\n          </div>\n          <!--email-->\n          <div class=\"col-md-6\">\n            <label class=\"required negrita\">Email</label>\n            <!-- <div class=\"alert alert-danger\" *ngIf=\"!myForm.controls.email_entidad.valid && myForm.controls.email_entidad.touched\">Este campo es obligatorio</div> -->\n            <input type=\"email\" [(ngModel)]=\"updateProj.entidad.email\" class=\"form-control\" formControlName=\"email_entidad\" placeholder=\"Dirección de Email\">\n          </div>\n        </div>\n        <div class=\"row\">\n          <div class=\"form-group col-md-6\">\n            <label class=\"required negrita\">Provincia</label>\n            <select class=\"form-control minimal\" formControlName=\"provincia_entidad\" [(ngModel)]=\"updateProjEntidadProvincia\">\n              <option *ngFor=\"let provincia of provincias\" [ngValue]=\"provincia\">\n                {{ provincia.nombre }}\n              </option>\n            </select>\n          </div>\n          <div class=\"col-md-5\">\n            <div class=\"form-group\">\n              <label class=\"required negrita\">Municipio</label>\n              <input type=\"text\" [(ngModel)]=\"updateProj.entidad.municipio\" class=\"form-control\" formControlName=\"municipio_entidad\" placeholder=\"Municipio de la entidad\">\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n      <div class=\"row\">\n        <!-- AMBITO -->\n        <div class=\"form-group col-md-6\">\n          <label class=\"required negrita\">Ambito</label>\n          <select class=\"form-control minimal\" formControlName=\"ambito\" [(ngModel)]=\"updateProjAmbito\" (change)=\"onChangeAmbito($event.target.value) \">\n            <option *ngFor=\"let ambito of ambitos\" [ngValue]=\"ambito\">\n              {{ ambito.nombre }}\n            </option>\n          </select>\n        </div>\n        <div *ngIf=\"especialidad != null\">\n          <!-- ESPECIALIDAD -->\n          <div class=\"form-group col-md-6\">\n            <label class=\"required negrita\">Especialidad</label>\n            <select class=\"form-control minimal\" formControlName=\"especialidad\" [(ngModel)]=\"updateProjEspecialidad\">\n              <option *ngFor=\"let especialidad of especialidades\" [ngValue]=\"especialidad\">\n                {{ especialidad.nombre }}\n              </option>\n            </select>\n          </div>\n        </div>\n      </div>\n      <div class=\"row\">\n        <div *ngIf=\"universidad != null\">\n          <!-- UNIVERSIDAD -->\n          <div class=\"form-group col-md-8\">\n            <label class=\"negrita\">Universidad</label>\n            <select class=\"form-control minimal\" formControlName=\"universidad\" [(ngModel)]=\"updateProjUniversidad\">\n              <option *ngFor=\"let universidad of universidades\" [ngValue]=\"universidad\">\n                {{ universidad.nombre }}\n              </option>\n            </select>\n          </div>\n        </div>\n        <!-- FECHA -->\n      </div>\n      <div class=\"row\">\n        <div *ngIf=\"fecha_inicio != null\">\n          <div class=\"form-group col-md-4\">\n            <label class=\"required negrita\">Fecha Inicio</label>\n            <div class=\"input-group\">\n              <input formControlName=\"fecha_inicio\" [(ngModel)]=\"model_ini\" class=\"form-control\" placeholder=\"dd-mm-yyyy\" name=\"dp\" ngbDatepicker\n                #d=\"ngbDatepicker\">\n              <button class=\"input-group-addon\" (click)=\"d.toggle()\" type=\"button\">\n                <i class=\"fa fa-calendar\" style=\"width: 1.2rem; height: 1rem; cursor: pointer;\"></i>\n              </button>\n            </div>\n          </div>\n        </div>\n        <div *ngIf=\"fecha_fin != null\">\n          <div class=\"form-group col-md-4\">\n            <label class=\"required negrita\">Fecha fin</label>\n            <div class=\"input-group\">\n              <input formControlName=\"fecha_fin\" [(ngModel)]=\"model_fin\" class=\"form-control\" placeholder=\"dd-mm-yyyy\" name=\"dp\" ngbDatepicker\n                #d=\"ngbDatepicker\">\n              <button class=\"input-group-addon\" (click)=\"d.toggle()\" type=\"button\">\n                <i class=\"fa fa-calendar\" style=\"width: 1.2rem; height: 1rem; cursor: pointer;\"></i>\n              </button>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <label class=\"required negrita\">Imagenes adjuntas</label>\n      <div *ngFor=\"let image of adjuntos; let i=index\">\n        <span class=\"fa fa-remove pull-right\" (click)=\"removeAdjunto(i, image.nombre_fichero)\"></span>\n        <img src=\"/assets/uploads/{{image.nombre_fichero}}\" width=\"500\" height=\"400\" class=\"d-inline-block align-top\" alt=\"\" />\n        <p></p>\n      </div>\n\n      <div class=\"form-group\">\n        <label class=\"negrita\" for=\"single\">Insertar archivo adjunto</label>\n        <input type=\"file\" class=\"form-control\" name=\"single\" ng2FileSelect [uploader]=\"uploader\" />\n      </div>\n      <div *ngIf=\"uploader.queue!=''\">\n        <table class=\"table\">\n          <thead>\n            <tr>\n              <th width=\"50%\">Nombre</th>\n              <th>Tamaño</th>\n              <th>Progreso</th>\n              <th>Estado</th>\n              <th>Acciones</th>\n            </tr>\n          </thead>\n          <tbody>\n            <tr *ngFor=\"let item of uploader.queue\">\n              <td>\n                <strong>{{ item.file.name }}</strong>\n              </td>\n              <td nowrap>{{ item.file.size/1024/1024 | number:'.2' }} MB</td>\n              <td>\n                <div class=\"progress\" style=\"margin-bottom: 0;\">\n                  <div class=\"progress-bar\" role=\"progressbar\" [ngStyle]=\"{ 'width': item.progress + '%' }\"></div>\n                </div>\n              </td>\n              <td class=\"text-center\">\n                <span *ngIf=\"item.isSuccess\">\n                  <i class=\"fa fa-check\" style=\"color:green\"></i>\n                </span>\n                <span *ngIf=\"item.isCancel\">\n                  <i class=\"fa fa-circle\" style=\"color:orange\"></i>\n                </span>\n                <span *ngIf=\"item.isError\">\n                  <i class=\"fa fa-cancel\" style=\"color:red\"></i>\n                </span>\n              </td>\n              <td nowrap>\n                <button type=\"button\" class=\"btn btn-success btn-xs\" (click)=\"subir(item)\" [disabled]=\"item.isReady || item.isUploading || item.isSuccess\">\n                  <span class=\"fa fa-upload\"></span> Subir\n                </button>\n                <button type=\"button\" class=\"btn btn-warning btn-xs\" (click)=\"item.cancel()\" [disabled]=\"!item.isUploading\">\n                  <span class=\"fa fa-ban\"></span> Cancelar\n                </button>\n                <button type=\"button\" class=\"btn btn-danger btn-xs\" (click)=\"eliminar(item)\">\n                  <span class=\"fa fa-trash\"></span> Borrar\n                </button>\n              </td>\n            </tr>\n          </tbody>\n        </table>\n      </div>\n      <!-- BOTONES -->\n      <div class=\"row\">\n        <div class=\"col-md-6\">\n          <button type=\"submit\" class=\"button submit\" [disabled]=\"!myForm.valid\">\n            <i class=\"fa fa-check\"></i> Aceptar cambios\n          </button>\n        </div>\n        <div class=\"col-md-6\">\n          <button type=\"button\" class=\"button cancel\" (click)=goback();>\n            <i class=\"fa fa-times\"></i> Cancelar\n          </button>\n        </div>\n        <div class=\"alert alert-danger\" *ngIf=\"message\">{{message}}</div>\n      </div>\n\n      <!-- <div class=\"margin-20\">\n        <div>myForm details:-</div>\n        <pre>Is myForm valid?: <br>{{myForm.valid | json}}</pre>\n        <pre>form value: <br>{{myForm.value | json}}</pre>\n      </div>  -->\n    </form>\n\n\n  </div>\n</div>"
...
var ProyectosUpdateComponent = /** @class */ (function () {
    /*CONSTRUCTOR*/
    function ProyectosUpdateComponent(authService, _expService, _projService, _router, _location, _fb) {
        var _this = this;
        this.authService = authService;
        this._expService = _expService;
        this._projService = _projService;
        ...
        if (this.updateProj.fecha_inicio != null) {
            this.model_ini = {
                ...
                month: moment(this.updateProj.fecha_inicio.toString(), "DD/MM/YYYY").month() + 1,
        ...
        if (this.updateProj.fecha_fin != null) {
            this.model_ini = {
                ...
                month: moment(this.updateProj.fecha_fin.toString(), "DD/MM/YYYY").month() + 1,
    ...
    ProyectosUpdateComponent.prototype.ngOnInit = function () {
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            var jsonResponse = JSON.parse(response);
            var campos = { nombre_local: item.file.name, nombre_fichero: jsonResponse.file };
            _this.filesToUpload.push(campos);
        };
    };
    ...
    ProyectosUpdateComponent.prototype.cargarCoordinadores = function () {
        var control = this.myForm.controls['coordinadores'];
        for (var index = 0; index < this.updateProj.coordinadores.length - 1; index++) {
            control.push(this.initCoordinador());
        }
    };
    ...
    ProyectosUpdateComponent.prototype.initAlumno = function () {
        return this._fb.group({
            'nombre': null,
            'email': null
        });
    };
    ProyectosUpdateComponent.prototype.cargarAlumnos = function () {
        var control = this.myForm.controls['alumnos'];
        for (var index = 0; index < this.updateProj.alumnos.length - 1; index++) {
            control.push(this.initAlumno());
        }
    };
    ProyectosUpdateComponent.prototype.addAlumno = function () {
        //console.log("Despues de borrar el cordinador: ", JSON.stringify(this.updateExp.coordinadores))
        var control = this.myForm.controls['alumnos'];
        this.updateProj.alumnos.push({ id: 0, nombre: '', email: '' });
        control.push(this.initAlumno());
    };
    ProyectosUpdateComponent.prototype.removeAlumno = function (i, email) {
        var control = this.myForm.controls['alumnos'];
        control.removeAt(i);
        this.updateProj.alumnos = this.updateProj.alumnos.filter(function (el) {
            return el.email !== email.value;
    ...
    ProyectosUpdateComponent.prototype.update = function (model) {
        ...
        this.adjuntos.forEach(function (element) {
            _this.proj.adjuntos.push(element);
        });
        this.filesToUpload.forEach(function (element) {
            var campos = {
                id: -1,
            ...
            _this.proj.adjuntos.push(campos);
        });
        ...
        //console.log("Modelo: ", model);
        this._projService.updateProyecto(this.proj, 0).subscribe(function (res) {
            if (res['success'] == true) {
...
exports.ProyectosUpdateComponent = ProyectosUpdateComponent;
...
var ProyectosService = /** @class */ (function () {
    function ProyectosService(_http) {
        ...
        this.base_url = 'api/proj';
        this.proyectoSource = new Subject_1.Subject();
    ...
    ProyectosService.prototype.getProyectos = function (id) {
        var _this = this;
        var headers = new http_1.Headers({ 'x-access-token': JSON.parse(JSON.stringify(id)) });
        headers.append('Content-Type', 'application/json');
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    ProyectosService.prototype.getProyectosByEstado = function (estadoId) {
        var _this = this;
        var headers = new http_1.Headers({ 'x-access-token': estadoId });
        headers.append('Content-Type', 'application/json');
        var options = new http_1.RequestOptions({ headers: headers });
        console.log("Accediendo al endpoint GET proyectos");
        return this._http.get(this.base_url + "/proyectos", options).map(function (res) { return _this.parseRes(res); });
    ...
    ProyectosService.prototype.updateProyecto = function (proyecto, accion) {
        var _this = this;
        console.log(proyecto);
        var body = JSON.stringify(proyecto);
        var headers = new http_1.Headers();
...
var ng_bootstrap_1 = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/index.js");
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var util_1 = __webpack_require__("./node_modules/@ng-bootstrap/ng-bootstrap/util/util.js");
...
var NgbDateCustomParserFormatter = /** @class */ (function (_super) {
    ...
    NgbDateCustomParserFormatter.prototype.parse = function (value) {
        if (value) {
            ...
            if (dateParts.length === 1 && util_1.isNumber(dateParts[0])) {
                return { day: util_1.toInteger(dateParts[0]), month: null, year: null };
            }
            else if (dateParts.length === 2 && util_1.isNumber(dateParts[0]) && util_1.isNumber(dateParts[1])) {
                return { day: util_1.toInteger(dateParts[0]), month: util_1.toInteger(dateParts[1]), year: null };
            }
            else if (dateParts.length === 3 && util_1.isNumber(dateParts[0]) && util_1.isNumber(dateParts[1]) && util_1.isNumber(dateParts[2])) {
                return { day: util_1.toInteger(dateParts[0]), month: util_1.toInteger(dateParts[1]), year: util_1.toInteger(dateParts[2]) };
            }
        }
        return null;
    };
    NgbDateCustomParserFormatter.prototype.format = function (date) {
        return date ?
            (util_1.isNumber(date.day) ? util_1.padNumber(date.day) : '') + "-" + (util_1.isNumber(date.month) ? util_1.padNumber(date.month) : '') + "-" + date.year :
            '';
    };
...
var PairsPipe = /** @class */ (function () {
    ...
    PairsPipe = __decorate([
        core_1.Pipe({ name: 'pairs', pure: false })
    ], PairsPipe);
    return PairsPipe;
}());
...
exports.UniversidadesAddComponent = UniversidadesAddComponent;
...
exports.UniversidadesEditComponent = UniversidadesEditComponent;
...
exports.UniversidadesListComponent = UniversidadesListComponent;
...
var user_1 = __webpack_require__("./src/app/components/user/user.ts");
var auth_service_1 = __webpack_require__("./src/app/auth.service.ts");
var match_other_validator_1 = __webpack_require__("./src/app/components/tools/match-other-validator.ts");
var ResetPassComponent = /** @class */ (function () {
    function ResetPassComponent(fb, authService, router, activatedRoute) {
        ...
        this.message = '';
        this.rForm = fb.group({
            'newPassword': [null, forms_1.Validators.compose([forms_1.Validators.required, forms_1.Validators.minLength(6), forms_1.Validators.maxLength(15)])],
            'confirmPassword': [null, forms_1.Validators.compose([forms_1.Validators.required, forms_1.Validators.minLength(6), forms_1.Validators.maxLength(15), match_other_validator_1.matchOtherValidator('newPassword')])],
            'validate': ''
        });
        this.rForm.valueChanges.subscribe(function (data) {
            _this.message = "";
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent() {
        ...
        this.actualizarUserEvent = new core_1.EventEmitter();
    }
...
var UserLoginComponent = /** @class */ (function () {
    function UserLoginComponent(authService, router, _location, fb) {
        ...
        this.rForm = fb.group({
            'email': ['', forms_1.Validators.email],
            'password': [null, forms_1.Validators.compose([forms_1.Validators.required, forms_1.Validators.minLength(6), forms_1.Validators.maxLength(15)])],
        });
        this.rForm.valueChanges.subscribe(function (data) {
            _this.message = "";
        });
...
var UserRegisterComponent = /** @class */ (function () {
    function UserRegisterComponent(authService, _userService, router, _location, fb) {
        var _this = this;
        this.authService = authService;
        this._userService = _userService;
        this.router = router;
        ...
        this.rForm = fb.group({
            ...
            'confirm-password': ['', forms_1.Validators.compose([forms_1.Validators.required, forms_1.Validators.minLength(6), forms_1.Validators.maxLength(15), match_other_validator_1.matchOtherValidator('password')])],
        });
        this.rForm.valueChanges.subscribe(function (data) {
            _this.message = "";
        });
...
exports.UserViewProfileComponent = UserViewProfileComponent;
